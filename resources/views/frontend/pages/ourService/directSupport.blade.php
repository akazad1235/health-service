...
<head>
	...
	<title>Direct Support Professionals | 1st Choice Family Service</title>
...
@extends('frontend.layouts.header')
		...
		<main id="main-content">
            ...
            style="background-image:url({{asset('frontend/assets/images/icon/DirectSupportProfessionalPage.jpg')}})">

            <div class="frame row grid-row">
                <h1 class="hide-logo-trigger">Direct Support Professional</h1>
                <p class="service-text service-text2">Our mission is to help people with developmental disabilities
                    overcome life challenges and
                    include them in society through advocation, informed decision-making, and total community
                    integration.</p>
            </div>
        </section>
        ...
        <section class="overview-locations">
            ...
            <div class="frame grid-row">
                ...
                <div class="col-lg-6 overview" data-anim="right">
                    <p>Our Direct support professionals are experts at HELPING PEOPLE make excellent life choices.
                    </p>
        ...
        <section id="get-started" class=" two-col gray-diagonal form-inside">
            <div class="teasers">
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Tailor-Made Partnership
                    </div>
                    <div class="teaser-item-text">Our DSPs are trained with weekly assessments about the clients’
                        goals and any new developments in science or medicine about their specific disability.</div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Intuitive And Intelligent Pairing
                    </div>
                    <div class="teaser-item-text">Our Instructors and course authors are also skilled mentors,
                        social workers, and personal development coaches that guarantee perfect pairing with
                        clients.</div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Unique Customized Approach</div>
                    <div class="teaser-item-text">No two people are alike. Thanks to our data tracking system, we
                        can handle various clients while maintaining a personal approach.</div>
                </div>
