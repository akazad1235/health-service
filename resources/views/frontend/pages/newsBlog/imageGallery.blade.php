...
<head>
	...
	<title>​Image Gallery | 1st Choice Family Service</title>
		...
		<main id="main-content">
            ...
            <section class="banner solid-blue">
                <div class="frame row grid-row">
                    ...
                    <div class="col-lg-7">
                        <h1 class="hide-logo-trigger">Image Gallery</h1>
                    </div>
                </div>
            </section>

            <div class="landing-archive grid-row">
                @foreach ($allImageGallery as $item)
				<div class="post-item">
                    <img src="{{asset('backend/img/gallery/'.$item->image)}}">
                </div>
				@endforeach
