...
<head>
	...
	<title>​DSP Hiring | 1st Choice Family Service</title>
...
<body class="service-template-default single single-service postid-364 interior-page"
	...
	<div id="site">
		...
		<main id="main-content">
            ...
            style="background-image:url({{asset('frontend/assets/images/NewPagePhotos02/03_Hiring.jpg')}})">

            <div class="frame row grid-row">
                <h1 class="hide-logo-trigger">Became A DSP</h1>
                <p class="service-text service-text2">Congratulations! You have decided to join
                    our team where you can get paid to make
                    a difference.</p>
            </div>
            </section>
            ...
            <div class="frame grid-row">
                ...
                <div class="col-lg-6 overview" data-anim="right">
                    <p>When you apply today, you will enter an
                        industry fully packaged with growth and
                        skills development opportunities.</p>

                    <p>If you are looking to get flexible hours and
                        financial stability with no experience
                        required, applying right now could end up
                        being the best decision you can take.</p>
            ...
            <div class="teasers">
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Steady Work</div>
                    <div class="teaser-item-text">High client demand and
                        intelligent pairing ensure
                        our staff always have work
                        at 1st CFS. </div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Flexibility
                    </div>
                    <div class="teaser-item-text">You select the hours you
                        have available to work with
                        us. This way, you can
                        manage other life activities
                        without sacrificing
                        anything.</div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Growth Opportunities
                    </div>
                    <div class="teaser-item-text">There is possibly no better
                        place to grow than the
                        healthcare industry right
                        now. Most of all, in the DD
                        industry where the
                        demand always rises. </div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-text">Get paid fast with our Bi
                        weekly payments. Have a
                        liquid financial status and
                        never delay your bills
                        again. </div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-text">We pride ourselves on
                        having a rating system that
                        pays you for performance
                        and upgrades your salary
                        based on your results. </div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Investment
                        Education

                    </div>
                    <div class="teaser-item-text">Don't know what to do with
                        your money? No problem.
                        We have a full team of
                        investment consultors to
                        empower our staff to make
                        adequate money decisions. </div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">24h Support


                    </div>
                    <div class="teaser-item-text">You are never alone.
                        There’s always somebody
                        just a phone call away to
                        assist you during an
                        emergency or any unusual
                        situation.</div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Performance Based
                        Bonuses


                    </div>
                    <div class="teaser-item-text">Are you a results-driven
                        person? Then you will love
                        it here. Our bonus on
                        performance ensures that you will
                        always get a reward for the
                        fantastic job you do.</div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-text">Professionalism is a must
                        here in 1st CFS; that’s why
                        we always make sure you
                        find chances to move up
                        the position ladder in our
                        family.</div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Competitive Wages

                    </div>
                    <div class="teaser-item-text">Our work demands a lot of sweat and
                        effort. So we provide our staff with wages
                        easily comparable with top leading
                        companies in other industries.</div>
                ...
                <div class="teaser-item" data-anim="in">
                    ...
                    <div class="teaser-item-name">Diverse Culture

                    </div>
                    <div class="teaser-item-text">With operations in over 14 countries
                        worldwide, our company is formed by a
                        multidisciplinary team coming from
                        everywhere around the world.</div>
                ...
                <div class="frame row ">
                    <div class="col-half" data-anim="left">
                        <h2>Get Started</h2>
                        <p>If you feel like having time flexibility, huge
                            growth opportunities, and getting home
                            happy every day after work suits you,
                            please click the link below to talk to one
                            of our coordinators. They will be more
